        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                if (isset($_POST['submit'])) {
                    // Sanitize inputs
                    $nama = addslashes(ucwords(trim($_POST['nama'])));
                    $ket = addslashes(trim($_POST['keterangan']));
                    ...
                    if (!in_array($formatfile, $allowedtype)) {
                        ...
                        if (move_uploaded_file($tmpname, "../uploads/jurusan1/" . $rename)) {
                            ...
                            $simpan = mysqli_query($koneksi, "INSERT INTO jurusan (nama_jurusan, keterangan, gambar) VALUES (
                                '$nama',
                                '$ket',
                                '$rename'
                            )");
